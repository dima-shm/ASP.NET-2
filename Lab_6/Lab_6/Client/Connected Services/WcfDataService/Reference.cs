...
// Исходное имя файла:
// Дата создания: 26.11.2018 22:52:31
namespace Client.WcfDataService
{
    ...
    public partial class WSSDAEntities : global::System.Data.Services.Client.DataServiceContext
    {
        ...
        {
            global::System.Type resolvedType = this.DefaultResolveType(typeName, "WSSDAModel", "Client.WcfDataService");
        ...
        {
            if (clientType.Namespace.Equals("Client.WcfDataService", global::System.StringComparison.Ordinal))
            {
