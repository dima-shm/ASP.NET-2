...
[System.Web.Services.WebServiceBindingAttribute(Name="SimplexSoap", Namespace="http://sda/")]
public partial class Simplex : System.Web.Services.Protocols.SoapHttpClientProtocol {
    
    private System.Threading.SendOrPostCallback AddOperationCompleted;
    
    private System.Threading.SendOrPostCallback AddJSOperationCompleted;
    ...
    /// <remarks/>
    public Simplex() {
        this.Url = "http://localhost:53016/Simplex.asmx";
    }
    ...
    /// <remarks/>
    public event AddJSCompletedEventHandler AddJSCompleted;
    ...
    /// <remarks/>
    [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://sda/Add", RequestNamespace="http://sda/", ResponseNamespace="http://sda/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
    ...
    /// <remarks/>
    [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://sda/ASMX.ADDJS", RequestElementName="ASMX.ADDJS", RequestNamespace="http://sda/", ResponseElementName="ASMX.ADDJSResponse", ResponseNamespace="http://sda/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
    [return: System.Xml.Serialization.XmlElementAttribute("ASMX.ADDJSResult")]
    public string AddJS(int firstParam, int secondParam) {
        object[] results = this.Invoke("AddJS", new object[] {
                    firstParam,
                    secondParam});
    ...
    /// <remarks/>
    public System.IAsyncResult BeginAddJS(int firstParam, int secondParam, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("AddJS", new object[] {
                    firstParam,
                    secondParam}, callback, asyncState);
    }
    
    /// <remarks/>
    public string EndAddJS(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((string)(results[0]));
    }
    
    /// <remarks/>
    public void AddJSAsync(int firstParam, int secondParam) {
        this.AddJSAsync(firstParam, secondParam, null);
    }
    
    /// <remarks/>
    public void AddJSAsync(int firstParam, int secondParam, object userState) {
        if ((this.AddJSOperationCompleted == null)) {
            this.AddJSOperationCompleted = new System.Threading.SendOrPostCallback(this.OnAddJSOperationCompleted);
        }
        this.InvokeAsync("AddJS", new object[] {
                    firstParam,
                    secondParam}, this.AddJSOperationCompleted, userState);
    }
    
    private void OnAddJSOperationCompleted(object arg) {
        if ((this.AddJSCompleted != null)) {
            System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
            this.AddJSCompleted(this, new AddJSCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
        }
    }
    
    /// <remarks/>
    [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://sda/Concat", RequestNamespace="http://sda/", ResponseNamespace="http://sda/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
    ...
    /// <remarks/>
    [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://sda/Sum", RequestNamespace="http://sda/", ResponseNamespace="http://sda/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
...
[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.ComponentModel.DesignerCategoryAttribute("code")]
[System.Xml.Serialization.XmlTypeAttribute(Namespace="http://sda/")]
...
/// <remarks/>
[System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "4.7.3081.0")]
public delegate void AddJSCompletedEventHandler(object sender, AddJSCompletedEventArgs e);

/// <remarks/>
[System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "4.7.3081.0")]
[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.ComponentModel.DesignerCategoryAttribute("code")]
public partial class AddJSCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
    
    private object[] results;
    
    internal AddJSCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
            base(exception, cancelled, userState) {
        this.results = results;
    }
